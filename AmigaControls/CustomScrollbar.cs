...
namespace migControls
{
    ...
    public class CustomScrollbar : UserControl {
        ...
        public CustomScrollbar() {
            ...
            UpArrowImage = AmigaControls.miscResources.uparrow;
            DownArrowImage = AmigaControls.miscResources.downarrow;


            ThumbBottomImage = AmigaControls.miscResources.ThumbBottom;
            ThumbBottomSpanImage = AmigaControls.miscResources.ThumbSpanBottom;
            ThumbTopImage = AmigaControls.miscResources.ThumbTop;
            ThumbTopSpanImage = AmigaControls.miscResources.ThumbSpanTop;
            ThumbMiddleImage = AmigaControls.miscResources.ThumbMiddle;
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            if (UpArrowImage != null)
            {
                ...
                Rectangle rtop = new Rectangle(new Point(0, 0), new Size(this.Width - 1, UpArrowImage.Height));
                e.Graphics.DrawRectangle(globalMig.stdWhitePen, rtop);
                e.Graphics.DrawString(this.topText, globalMig.topaz_std12, globalMig.stdOrangeBrush, 0, 1);
            ...
            e.Graphics.FillRectangle(migControls.globalMig.stdWhiteBrush, new Rectangle(0,UpArrowImage.Height, 1, (this.Height-DownArrowImage.Height)));
            e.Graphics.FillRectangle(migControls.globalMig.stdWhiteBrush, new Rectangle(this.Width-1, UpArrowImage.Height, 1, (this.Height - DownArrowImage.Height)));

            ////draw channel
           // e.Graphics.FillRectangle(migControls.globalMig.stdBlueBrush, new Rectangle(1, UpArrowImage.Height, this.Width-2, (this.Height-DownArrowImage.Height)));
            ...
            int totalHeight = (nSpanHeight*2) +  (ThumbTopImage.Height) + ThumbMiddleImage.Height;
            Rectangle r1 = new Rectangle(1, nTop, this.Width - 2, totalHeight);


            e.Graphics.FillRectangle(globalMig.stdOrangeBrush, r1);
...
/*
          ...
          //  e.Graphics.DrawImage(ThumbMiddleImage, new Rectangle(1, nTop, this.Width - 2, ThumbMiddleImage.Height));
            ...
            if (DownArrowImage != null)
            {
                ...
                Rectangle btmRect = new Rectangle(new Point(0, (this.Height - DownArrowImage.Height)), new Size(this.Width, DownArrowImage.Height -1));
                ...
                e.Graphics.DrawRectangle(globalMig.stdWhitePen, btmRect);
                e.Graphics.DrawString(this.botText, globalMig.topaz_std12,globalMig.stdWhiteBrush,1, (this.Height - DownArrowImage.Height)+1);
