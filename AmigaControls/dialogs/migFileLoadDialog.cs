...
{
    public partial class migFileLoadDialog : migform
    {
        ...
        public delegate void fileSelectLoadEventHandler(object sender, migFileLoadSelect e);
        public event fileSelectLoadEventHandler onFileSelected;
        ...
        public class migFileLoadSelect : EventArgs
        {
            public migFileLoadSelect(string _path, string _file)
            {
                this.selectedPath = _path;
                this.selectedFile = _file;
            }

            public migFileLoadSelect(string _path, string _file, DialogResult _res)
            {
                this.selectedPath = _path;
                this.selectedFile = _file;
            ...
            public migFileLoadSelect(string _path, string _file, string _fullPath)
            {
                this.selectedPath = _path;
                this.selectedFile = _file;
        ...
        private void migButton1_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(selectedFile) && System.IO.File.Exists(selectedFile))
            {
                ...
                {
                    onFileSelected(this, new migFileLoadSelect(finf.DirectoryName, finf.Name, finf.FullName));
                    this.Close();
